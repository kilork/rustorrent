...
impl PeerLoopMessage {
    pub(crate) async fn bitfield(&mut self, pieces: Vec<u8>) -> Result<bool, RustorrentError> {
    ...
    pub(crate) async fn have(&mut self, piece_index: usize) -> Result<bool, RustorrentError> {
        let peer_id = self.peer_id;
    ...
    pub(crate) async fn unchoke(&mut self) -> Result<bool, RustorrentError> {
        self.chocked = false;
    ...
    pub(crate) async fn interested(&mut self) -> Result<bool, RustorrentError> {
